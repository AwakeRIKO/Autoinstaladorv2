...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do EasyConverse que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador EasyConverse, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar EasyConverse\n"
  printf "   [1] Atualizar EasyConverse\n"
  printf "   [2] Deletar EasyConverse\n"
  printf "   [3] Bloquear EasyConverse\n"
  printf "   [4] Desbloquear EasyConverse\n"
  printf "   [5] Alter. dominio EasyConverse\n"
  printf "\n"
  read -p "> " option
